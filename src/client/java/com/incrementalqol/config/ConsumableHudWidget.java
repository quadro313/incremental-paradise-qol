...
public class ConsumableHudWidget extends ClickableWidget {
    ...
    public ConsumableHudWidget(int x, int y, int width, int height) {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        float scaleFactor = (float) this.config.getConsumableHudScale();
